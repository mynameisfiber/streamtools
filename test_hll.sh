...
curl "localhost:7070/create?blockType=hll&id=hll"
curl localhost:7070/blocks/hll/set_rule -d '{"Value":"stAddress1","ErrorRate":0.001}'
curl "localhost:7070/connect?from=unpacker&to=hll"
